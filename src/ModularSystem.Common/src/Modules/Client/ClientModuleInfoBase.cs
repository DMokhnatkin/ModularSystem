...
{
    public abstract class ClientModuleInfoBase : IModuleInfo
    {
        protected ClientModuleInfoBase(ModuleIdentity moduleIdentity, ModuleIdentity[] serverDependencies, ModuleIdentity[] clientDependencies)
        {
