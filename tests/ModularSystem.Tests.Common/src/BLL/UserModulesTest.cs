    ...
    public class UserModulesTest
    {
        ...
        public void InitializeTest()
        {
            ...
            _samplePackagedModules[0] =
                new ZipPackagedModule { ModuleInfo = new ModuleInfo(new ModuleIdentity("test.server", "1.0"), new ModuleIdentity[0]) };
            _samplePackagedModules[1] =
                new ZipPackagedModule { ModuleInfo = new ModuleInfo(new ModuleIdentity("test.client", "1.0"), new[] { _samplePackagedModules[0].ModuleInfo.ModuleIdentity }) };
            _samplePackagedModules[2] =
                new ZipPackagedModule { ModuleInfo = new ModuleInfo(new ModuleIdentity("test.server", "2.0"), new[] { _samplePackagedModules[0].ModuleInfo.ModuleIdentity }) };
            _samplePackagedModules[3] =
                new ZipPackagedModule { ModuleInfo = new ModuleInfo(new ModuleIdentity("test.client", "2.0"), new[] { _samplePackagedModules[1].ModuleInfo.ModuleIdentity, _samplePackagedModules[2].ModuleInfo.ModuleIdentity }) };
            _samplePackagedModules[4] =
                new ZipPackagedModule {ModuleInfo = new ModuleInfo(new ModuleIdentity("test2.client", "1.0"), new ModuleIdentity[0]) };
